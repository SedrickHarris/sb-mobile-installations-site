...
### Alternative when no active opening fits

Route users to the installer network with an explicit statement that it is a registration for future opportunities and not an application for a specific opening.
